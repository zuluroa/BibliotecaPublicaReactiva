...
@Service
@Validated
public class ActualizarRecursoUseCase implements CrearRecurso {

    private final RepositorioRecurso repositorioRecurso;
    private final RecursoMapper mapper;

    public ActualizarRecursoUseCase(RepositorioRecurso repositorioRecurso, RecursoMapper mapper) {
