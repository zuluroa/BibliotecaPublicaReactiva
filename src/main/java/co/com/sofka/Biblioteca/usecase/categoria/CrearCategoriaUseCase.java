...
@Service
@Validated
public class CrearCategoriaUseCase implements GuardarCartegoria {

    private final RepositorioCategoria repositorioCategoria;
    private final CategoriaMapper categoriaMapper;

    public CrearCategoriaUseCase(RepositorioCategoria repositorioCategoria, CategoriaMapper categoriaMapper) {
    ...
    public Mono<CategoriaDTO> save(CategoriaDTO categoriaDTO) {
        return repositorioCategoria.save(categoriaMapper.dtoToCategoria().apply(categoriaDTO)).map(categoriaMapper.CategoriaToDTO());
    }
}
