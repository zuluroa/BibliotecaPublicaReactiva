...
@Service
@Validated
public class ActualizarTipoRecursoUseCase implements CrearTipoServicio {

    private final RepositorioTipoRecurso repositorioTipoRecurso;
    private final TipoRecursoMapper tipoRecursoMapper;

    @Autowired
    public ActualizarTipoRecursoUseCase(RepositorioTipoRecurso repositorioTipoRecurso, TipoRecursoMapper tipoRecursoMapper) {
